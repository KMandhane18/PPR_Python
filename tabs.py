...
def create_person_func():
    ...
    # print_hi(name_person, age_person)
    ...
    update_person_button = st.button("Update Person", use_container_width=True, type="secondary")
    ...
    if update_person_button:
        pass
        # update_person(name_person, age_person, type_node)
